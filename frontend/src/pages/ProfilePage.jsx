...
const ProfilePage = () => {
  ...
  // Estabelce conexão para o carregamento da imagem
    ...
    <div className="h-screen pt-20">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          {/* Parte de cima das informações */}
          <div className="text-center">
            <h1 className="text-2xl font-semibold ">Perfil</h1>
            <p className="mt-2">Informações do perfil</p>
          </div>

          {/* Seção para o carregamento de imagem */}
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-zinc-400">
              {isUpdatingProfile
                ? "Atualizando..."
                : "Clique no ícone da câmera para carregar sua imagem"}
            </p>
          </div>
